#!/bin/bash
#SBATCH --job-name=w2c_transfer_eval
...
#SBATCH --mem=32G
#SBATCH --output=eval/slurm/%x-%A_%a.out
#SBATCH --error=eval/slurm/%x-%A_%a.err
...
"$PYTHON" -u -m tests.eval_walker_to_cheetah_transfer \
